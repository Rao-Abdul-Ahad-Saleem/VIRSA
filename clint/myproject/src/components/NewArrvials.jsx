...
const NextArrow = ({ onClick, currentSlide, slideCount }) => {
    ...
    // const lastSlideIndex = slideCount - slidesToScroll
    // console.log(`Current Slide${currentSlide}, slideCount ${slideCount}`);
    // If the current slide is the last slide, don't render the arrow
...
const NewArrivals = () => {
    ...
    //         console.log(`Navbar Widht : ${navbarWidth}`)
    ...
    return (
        <div className='px-5 py-5' >
            <div className='px-3'>
                <h2 className='text-xl font-bold pb-1'>{`New Arrivals`.toUpperCase()}</h2>
